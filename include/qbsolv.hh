...
// - random seed
typedef void (*SubSolver)(double**, int, int8_t*, void*, int64_t*, double*);
...
void trace_subsample(double **sub_qubo, int subMatrix, int8_t *sub_solution, void *sub_sampler_data, int64_t* accepted_flips, double* remove_time);
